	...
	<body>
		<form method="POST" encType="multipart/form-data">
			...
			<table border="1" align="center">
				<tr>
					<th>상품이름</th>
					<td><input name="g_name" value="${vo.g_name}" style="width:250px;" ></td>
				</tr>
				<tr>
					<th>가격</th>
					<td><input name="g_price" value="${vo.g_price}"></td>
				</tr>
				<tr>
					<th>상품 타이틀 이미지</th>
				...
				<tr>
					<th>할인율</th>
					<td><input name=sale value="${vo.sale}"></td>
				</tr>
				<tr>
					<th>상품타입</th>
				...
				<tr>
					<td colspan="2"> 
						<input type="button" value="상품수정" onclick="send(this.form)">
