...
public class Context_2_mybatis {
	...
	//Factory객체(SqlSessionFatory클래스)Factory객체가 db에 접근하는 방법을 알고 있는 객체
	@Bean //db연결객체
...
//        SqlSessionFactoryBean 객체 자체를 생성하는 것이 아니라
	...
	//SQL을 처리하는 마이바티스 메서드를 호출할 때, SqlSessionTemplate은 Sqlsession이
	//현재의 스프링 트랜잭션이 사용될 수 있도록
	//보장해준다.
	
	//SqlSessionTemplate은 필요한 시점에서 셋녀을 닫고,
